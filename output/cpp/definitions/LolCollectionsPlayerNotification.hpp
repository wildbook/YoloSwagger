#ifndef SWAGGER_TYPES_LolCollectionsPlayerNotification_HPP
#define SWAGGER_TYPES_LolCollectionsPlayerNotification_HPP
#include <json.hpp>
namespace leagueapi {
  // 
  ...
  inline void to_json(nlohmann::json& j, const LolCollectionsPlayerNotification& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolCollectionsPlayerNotification& v) {
...
#endif // SWAGGER_TYPES_LolCollectionsPlayerNotification_HPP
