...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolLobbyTeamBuilderTbLobbyBackwardsToPremadeTransitionResource& v) {
    j["backwardsTransitionReason"] = v.backwardsTransitionReason;
    j["slotIds"] = v.slotIds;
  }

  inline void from_json(const nlohmann::json& j, LolLobbyTeamBuilderTbLobbyBackwardsToPremadeTransitionResource& v) {
