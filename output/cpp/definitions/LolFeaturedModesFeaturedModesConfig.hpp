...
namespace leagueapi {
  struct LolFeaturedModesFeaturedModesConfig_t {
    uint32_t_t MaxNotificationSaveDelayMinutes;
    bool_t NotificationsEnabled;
    uint32_t_t QueueToggleNotificationMinutesThreshold;
  };
  ...
  inline void from_json(const nlohmann::json& j, LolFeaturedModesFeaturedModesConfig_t& v) {
    v.MaxNotificationSaveDelayMinutes = j.at("MaxNotificationSaveDelayMinutes").get<uint32_t_t>();
    v.NotificationsEnabled = j.at("NotificationsEnabled").get<bool_t>();
    v.QueueToggleNotificationMinutesThreshold = j.at("QueueToggleNotificationMinutesThreshold").get<uint32_t_t>();
  }
