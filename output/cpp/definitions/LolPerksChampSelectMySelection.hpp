...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolPerksChampSelectMySelection& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolPerksChampSelectMySelection& v) {
