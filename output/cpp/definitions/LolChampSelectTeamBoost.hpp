#ifndef SWAGGER_TYPES_LolChampSelectTeamBoost_HPP
#define SWAGGER_TYPES_LolChampSelectTeamBoost_HPP
#include <json.hpp>
namespace leagueapi {
  // 
  ...
  inline void to_json(nlohmann::json& j, const LolChampSelectTeamBoost& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolChampSelectTeamBoost& v) {
...
#endif // SWAGGER_TYPES_LolChampSelectTeamBoost_HPP
