...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolLobbyTeamBuilderChampSelectMySelection& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolLobbyTeamBuilderChampSelectMySelection& v) {
