...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolEndOfGameRerollDataBagForClientV1& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolEndOfGameRerollDataBagForClientV1& v) {
