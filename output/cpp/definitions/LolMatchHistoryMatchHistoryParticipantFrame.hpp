...
namespace leagueapi {
  struct LolMatchHistoryMatchHistoryParticipantFrame_t {
    int32_t_t totalGold;
    uint16_t_t teamScore;
    uint16_t_t participantId;
    uint16_t_t level;
    int32_t_t currentGold;
    uint16_t_t minionsKilled;
    uint16_t_t dominionScore;
    LolMatchHistoryMatchHistoryPosition_t position;
    uint32_t_t xp;
    uint16_t_t jungleMinionsKilled;
  };
  ...
  inline void from_json(const nlohmann::json& j, LolMatchHistoryMatchHistoryParticipantFrame_t& v) {
    v.totalGold = j.at("totalGold").get<int32_t_t>();
    v.teamScore = j.at("teamScore").get<uint16_t_t>();
    v.participantId = j.at("participantId").get<uint16_t_t>();
    v.level = j.at("level").get<uint16_t_t>();
    v.currentGold = j.at("currentGold").get<int32_t_t>();
    v.minionsKilled = j.at("minionsKilled").get<uint16_t_t>();
    v.dominionScore = j.at("dominionScore").get<uint16_t_t>();
    v.position = j.at("position").get<LolMatchHistoryMatchHistoryPosition_t>();
    v.xp = j.at("xp").get<uint32_t_t>();
    v.jungleMinionsKilled = j.at("jungleMinionsKilled").get<uint16_t_t>();
  }
