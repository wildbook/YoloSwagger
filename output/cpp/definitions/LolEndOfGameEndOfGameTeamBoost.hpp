#ifndef SWAGGER_TYPES_LolEndOfGameEndOfGameTeamBoost_HPP
#define SWAGGER_TYPES_LolEndOfGameEndOfGameTeamBoost_HPP
#include <json.hpp>
namespace leagueapi {
  // 
  ...
  inline void to_json(nlohmann::json& j, const LolEndOfGameEndOfGameTeamBoost& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolEndOfGameEndOfGameTeamBoost& v) {
...
#endif // SWAGGER_TYPES_LolEndOfGameEndOfGameTeamBoost_HPP
