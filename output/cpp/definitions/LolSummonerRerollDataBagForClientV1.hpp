...
namespace leagueapi {
  struct LolSummonerRerollDataBagForClientV1_t {
    int64_t_t totalPoints;
    int64_t_t pointsGainedLastGame;
    int32_t_t rerollCount;
    uint32_t_t maximumRerolls;
    int64_t_t pointCostOfReroll;
    int64_t_t pointsUntilNextReroll;
  };
  ...
  inline void from_json(const nlohmann::json& j, LolSummonerRerollDataBagForClientV1_t& v) {
    v.totalPoints = j.at("totalPoints").get<int64_t_t>();
    v.pointsGainedLastGame = j.at("pointsGainedLastGame").get<int64_t_t>();
    v.rerollCount = j.at("rerollCount").get<int32_t_t>();
    v.maximumRerolls = j.at("maximumRerolls").get<uint32_t_t>();
    v.pointCostOfReroll = j.at("pointCostOfReroll").get<int64_t_t>();
    v.pointsUntilNextReroll = j.at("pointsUntilNextReroll").get<int64_t_t>();
  }
