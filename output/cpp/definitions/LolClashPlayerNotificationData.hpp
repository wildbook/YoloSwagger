...
namespace leagueapi {
  ...
  inline void from_json(const nlohmann::json& j, LolClashPlayerNotificationData_t& v) {
    v.sourceSummonerId = j.at("sourceSummonerId").get<uint64_t_t>();
    ...
    v.targetSummonerId = j.at("targetSummonerId").get<uint64_t_t>();
  }
