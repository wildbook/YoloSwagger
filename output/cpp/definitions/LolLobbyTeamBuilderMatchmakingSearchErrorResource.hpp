...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolLobbyTeamBuilderMatchmakingSearchErrorResource& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolLobbyTeamBuilderMatchmakingSearchErrorResource& v) {
