...
#include <optional>
namespace leagueapi {
  struct PlayerNotificationResource_t {
  ...
  inline void to_json(nlohmann::json& j, const PlayerNotificationResource_t& v) {
  ...
  inline void from_json(const nlohmann::json& j, PlayerNotificationResource_t& v) {
  ...
  inline std::string to_string(const PlayerNotificationResource_t& v) {
    nlohmann::json j = v;
    return j.dump();  }
