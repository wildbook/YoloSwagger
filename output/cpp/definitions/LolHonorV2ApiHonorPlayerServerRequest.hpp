...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolHonorV2ApiHonorPlayerServerRequest& v) {
    j["gameId"] = v.gameId;
    j["honorCategory"] = v.honorCategory;
    j["summonerId"] = v.summonerId;
  }

  inline void from_json(const nlohmann::json& j, LolHonorV2ApiHonorPlayerServerRequest& v) {
