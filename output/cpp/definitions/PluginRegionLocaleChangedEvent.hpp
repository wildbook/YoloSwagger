...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const PluginRegionLocaleChangedEvent& v) {
    j["locale"] = v.locale;
    j["region"] = v.region;
  }

  inline void from_json(const nlohmann::json& j, PluginRegionLocaleChangedEvent& v) {
