...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolPlayerBehaviorPlayerBehavior_SimpleMessage& v) {
    j["msgId"] = v.msgId;
    j["type"] = v.type;
    j["params"] = v.params;
  ...
  inline void from_json(const nlohmann::json& j, LolPlayerBehaviorPlayerBehavior_SimpleMessage& v) {
