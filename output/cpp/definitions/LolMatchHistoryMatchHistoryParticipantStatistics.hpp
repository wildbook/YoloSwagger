...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolMatchHistoryMatchHistoryParticipantStatistics& v) {
    j["item1"] = v.item1;
  ...
  inline void from_json(const nlohmann::json& j, LolMatchHistoryMatchHistoryParticipantStatistics& v) {
