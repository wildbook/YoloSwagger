...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LeaguesLcdsSummonerLeagueItemsDTO& v) {
    j["summonerLeagues"] = v.summonerLeagues;
  }

  inline void from_json(const nlohmann::json& j, LeaguesLcdsSummonerLeagueItemsDTO& v) {
