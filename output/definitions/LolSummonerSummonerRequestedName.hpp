...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolSummonerSummonerRequestedName& v) {
    j["name"] = v.name;
  }

  inline void from_json(const nlohmann::json& j, LolSummonerSummonerRequestedName& v) {
