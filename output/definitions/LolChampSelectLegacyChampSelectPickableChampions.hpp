...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolChampSelectLegacyChampSelectPickableChampions& v) {
    j["championIds"] = v.championIds;
  }

  inline void from_json(const nlohmann::json& j, LolChampSelectLegacyChampSelectPickableChampions& v) {
