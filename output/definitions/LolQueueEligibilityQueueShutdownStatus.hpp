...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolQueueEligibilityQueueShutdownStatus& v) {
    j["isDisabled"] = v.isDisabled;
  }

  void from_json(const nlohmann::json& j, LolQueueEligibilityQueueShutdownStatus& v) {
