...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolChampSelectLegacyTeamBoost& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolChampSelectLegacyTeamBoost& v) {
...
#endif // SWAGGER_TYPES_LolChampSelectLegacyTeamBoost_HPP
