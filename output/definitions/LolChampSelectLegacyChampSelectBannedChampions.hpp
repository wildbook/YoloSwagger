...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolChampSelectLegacyChampSelectBannedChampions& v) {
    j["myTeamBans"] = v.myTeamBans;
    j["numBans"] = v.numBans;
    j["theirTeamBans"] = v.theirTeamBans;
  }

  void from_json(const nlohmann::json& j, LolChampSelectLegacyChampSelectBannedChampions& v) {
