...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const LolClashRosterDynamicStateNotification& v) {
    j["notifyReason"] = v.notifyReason;
    j["rosterDynamicState"] = v.rosterDynamicState;
    j["sourcePlayerId"] = v.sourcePlayerId;
  }

  void from_json(const nlohmann::json& j, LolClashRosterDynamicStateNotification& v) {
