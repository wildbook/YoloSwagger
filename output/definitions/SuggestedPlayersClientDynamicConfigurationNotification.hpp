...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const SuggestedPlayersClientDynamicConfigurationNotification& v) {
    j["configs"] = v.configs;
    j["delta"] = v.delta;
  }

  void from_json(const nlohmann::json& j, SuggestedPlayersClientDynamicConfigurationNotification& v) {
