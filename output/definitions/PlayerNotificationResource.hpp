#ifndef SWAGGER_TYPES_PlayerNotificationResource_HPP
#define SWAGGER_TYPES_PlayerNotificationResource_HPP
#include <json.hpp>
namespace leagueapi {
  // 
...
#endif // SWAGGER_TYPES_PlayerNotificationResource_HPP
