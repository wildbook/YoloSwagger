...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolPersonalizedOffersLoginSessionStates& v) {
    switch(v) {
  ...
  void from_json(const nlohmann::json& j, LolPersonalizedOffersLoginSessionStates& v) {
