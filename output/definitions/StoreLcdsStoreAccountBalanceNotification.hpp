...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const StoreLcdsStoreAccountBalanceNotification& v) {
    j["ip"] = v.ip;
    j["rp"] = v.rp;
  }

  inline void from_json(const nlohmann::json& j, StoreLcdsStoreAccountBalanceNotification& v) {
