...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolClashMatchmakingReadyCheckResponse& v) {
    switch(v) {
  ...
  void from_json(const nlohmann::json& j, LolClashMatchmakingReadyCheckResponse& v) {
