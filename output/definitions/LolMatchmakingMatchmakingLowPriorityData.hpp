...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolMatchmakingMatchmakingLowPriorityData& v) {
  ...
  void from_json(const nlohmann::json& j, LolMatchmakingMatchmakingLowPriorityData& v) {
