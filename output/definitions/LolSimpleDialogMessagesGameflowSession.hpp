...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolSimpleDialogMessagesGameflowSession& v) {
    j["phase"] = v.phase;
  }

  inline void from_json(const nlohmann::json& j, LolSimpleDialogMessagesGameflowSession& v) {
