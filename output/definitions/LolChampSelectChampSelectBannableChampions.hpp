...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolChampSelectChampSelectBannableChampions& v) {
    j["championIds"] = v.championIds;
  }

  void from_json(const nlohmann::json& j, LolChampSelectChampSelectBannableChampions& v) {
