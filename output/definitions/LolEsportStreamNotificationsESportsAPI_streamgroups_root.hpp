...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const LolEsportStreamNotificationsESportsAPI_streamgroups_root& v) {
    j["highlanderTournaments"] = v.highlanderTournaments;
    j["streamgroups"] = v.streamgroups;
    j["teams"] = v.teams;
  }

  void from_json(const nlohmann::json& j, LolEsportStreamNotificationsESportsAPI_streamgroups_root& v) {
