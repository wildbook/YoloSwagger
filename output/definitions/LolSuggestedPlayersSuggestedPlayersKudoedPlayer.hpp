...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolSuggestedPlayersSuggestedPlayersKudoedPlayer& v) {
    j["kudoedSummonerId"] = v.kudoedSummonerId;
    j["kudoedSummonerName"] = v.kudoedSummonerName;
  }

  inline void from_json(const nlohmann::json& j, LolSuggestedPlayersSuggestedPlayersKudoedPlayer& v) {
