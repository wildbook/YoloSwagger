#ifndef SWAGGER_TYPES_LolEndOfGameEndOfGamePlayer_HPP
#define SWAGGER_TYPES_LolEndOfGameEndOfGamePlayer_HPP
#include <json.hpp>
namespace leagueapi {
  // 
  ...
  inline void to_json(nlohmann::json& j, const LolEndOfGameEndOfGamePlayer& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolEndOfGameEndOfGamePlayer& v) {
...
#endif // SWAGGER_TYPES_LolEndOfGameEndOfGamePlayer_HPP
