...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolLoadoutsCreateOrUpdateItemsRequest& v) {
    j["id"] = v.id;
    j["inventoryJWTs"] = v.inventoryJWTs;
    j["items"] = v.items;
  }

  void from_json(const nlohmann::json& j, LolLoadoutsCreateOrUpdateItemsRequest& v) {
