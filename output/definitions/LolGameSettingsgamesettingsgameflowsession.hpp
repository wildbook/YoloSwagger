...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolGameSettingsgamesettingsgameflowsession& v) {
    j["gameClient"] = v.gameClient;
  }

  inline void from_json(const nlohmann::json& j, LolGameSettingsgamesettingsgameflowsession& v) {
