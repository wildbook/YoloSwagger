...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const LolFeaturedModesPlayerNotificationResource& v) {
  ...
  void from_json(const nlohmann::json& j, LolFeaturedModesPlayerNotificationResource& v) {
