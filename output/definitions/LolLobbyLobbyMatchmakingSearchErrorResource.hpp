...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const LolLobbyLobbyMatchmakingSearchErrorResource& v) {
  ...
  void from_json(const nlohmann::json& j, LolLobbyLobbyMatchmakingSearchErrorResource& v) {
