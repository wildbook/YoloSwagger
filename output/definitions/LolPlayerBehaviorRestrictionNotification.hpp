...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolPlayerBehaviorRestrictionNotification& v) {
  ...
  void from_json(const nlohmann::json& j, LolPlayerBehaviorRestrictionNotification& v) {
