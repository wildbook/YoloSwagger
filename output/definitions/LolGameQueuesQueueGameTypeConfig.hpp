#ifndef SWAGGER_TYPES_LolGameQueuesQueueGameTypeConfig_HPP
#define SWAGGER_TYPES_LolGameQueuesQueueGameTypeConfig_HPP
#include <json.hpp>
namespace leagueapi {
  // 
...
#endif // SWAGGER_TYPES_LolGameQueuesQueueGameTypeConfig_HPP
