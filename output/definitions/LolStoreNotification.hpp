#ifndef SWAGGER_TYPES_LolStoreNotification_HPP
#define SWAGGER_TYPES_LolStoreNotification_HPP
#include <json.hpp>
namespace leagueapi {
  // 
  ...
  inline void to_json(nlohmann::json& j, const LolStoreNotification& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolStoreNotification& v) {
...
#endif // SWAGGER_TYPES_LolStoreNotification_HPP
