...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const CollectionsLcdsStoreFulfillmentNotification& v) {
    j["data"] = v.data;
    j["inventoryType"] = v.inventoryType;
  }

  void from_json(const nlohmann::json& j, CollectionsLcdsStoreFulfillmentNotification& v) {
