...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const LolQueueEligibilityCollectionsPlayableChampionCounts& v) {
    j["championsOwned"] = v.championsOwned;
  }

  void from_json(const nlohmann::json& j, LolQueueEligibilityCollectionsPlayableChampionCounts& v) {
