#ifndef SWAGGER_TYPES_LolMissionsMissionsNotificationResource_HPP
#define SWAGGER_TYPES_LolMissionsMissionsNotificationResource_HPP
#include <json.hpp>
namespace leagueapi {
  // 
  ...
  inline void to_json(nlohmann::json& j, const LolMissionsMissionsNotificationResource& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolMissionsMissionsNotificationResource& v) {
...
#endif // SWAGGER_TYPES_LolMissionsMissionsNotificationResource_HPP
