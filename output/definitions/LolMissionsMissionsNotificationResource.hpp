...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolMissionsMissionsNotificationResource& v) {
  ...
  void from_json(const nlohmann::json& j, LolMissionsMissionsNotificationResource& v) {
