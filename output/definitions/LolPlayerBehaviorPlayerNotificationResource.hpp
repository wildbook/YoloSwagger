...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolPlayerBehaviorPlayerNotificationResource& v) {
  ...
  void from_json(const nlohmann::json& j, LolPlayerBehaviorPlayerNotificationResource& v) {
