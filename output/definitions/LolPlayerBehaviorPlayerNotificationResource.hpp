#ifndef SWAGGER_TYPES_LolPlayerBehaviorPlayerNotificationResource_HPP
#define SWAGGER_TYPES_LolPlayerBehaviorPlayerNotificationResource_HPP
#include <json.hpp>
namespace leagueapi {
  // 
  ...
  inline void to_json(nlohmann::json& j, const LolPlayerBehaviorPlayerNotificationResource& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolPlayerBehaviorPlayerNotificationResource& v) {
...
#endif // SWAGGER_TYPES_LolPlayerBehaviorPlayerNotificationResource_HPP
