...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolLobbyTeamBuilderMatchmakingDodgeWarning& v) {
    switch(v) {
  ...
  void from_json(const nlohmann::json& j, LolLobbyTeamBuilderMatchmakingDodgeWarning& v) {
