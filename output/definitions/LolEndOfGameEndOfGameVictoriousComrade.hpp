...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolEndOfGameEndOfGameVictoriousComrade& v) {
    j["summonerId"] = v.summonerId;
    j["summonerName"] = v.summonerName;
  }

  inline void from_json(const nlohmann::json& j, LolEndOfGameEndOfGameVictoriousComrade& v) {
