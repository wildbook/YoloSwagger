...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolLobbyTeamBuilderChampSelectPlayerSelection& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolLobbyTeamBuilderChampSelectPlayerSelection& v) {
...
#endif // SWAGGER_TYPES_LolLobbyTeamBuilderChampSelectPlayerSelection_HPP
