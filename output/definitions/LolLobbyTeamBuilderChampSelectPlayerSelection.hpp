...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolLobbyTeamBuilderChampSelectPlayerSelection& v) {
  ...
  void from_json(const nlohmann::json& j, LolLobbyTeamBuilderChampSelectPlayerSelection& v) {
