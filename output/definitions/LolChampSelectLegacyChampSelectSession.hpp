...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolChampSelectLegacyChampSelectSession& v) {
    j["actions"] = v.actions;
  ...
  void from_json(const nlohmann::json& j, LolChampSelectLegacyChampSelectSession& v) {
