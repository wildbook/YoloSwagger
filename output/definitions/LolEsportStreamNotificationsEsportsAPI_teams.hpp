...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolEsportStreamNotificationsEsportsAPI_teams& v) {
    j["acronym"] = v.acronym;
    j["guid"] = v.guid;
    j["id"] = v.id;
    j["logoUrl"] = v.logoUrl;
  ...
  void from_json(const nlohmann::json& j, LolEsportStreamNotificationsEsportsAPI_teams& v) {
