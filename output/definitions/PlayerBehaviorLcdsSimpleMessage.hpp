...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const PlayerBehaviorLcdsSimpleMessage& v) {
  ...
  inline void from_json(const nlohmann::json& j, PlayerBehaviorLcdsSimpleMessage& v) {
