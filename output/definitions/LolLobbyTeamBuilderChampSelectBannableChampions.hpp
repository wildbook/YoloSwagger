...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const LolLobbyTeamBuilderChampSelectBannableChampions& v) {
    j["championIds"] = v.championIds;
  }

  void from_json(const nlohmann::json& j, LolLobbyTeamBuilderChampSelectBannableChampions& v) {
