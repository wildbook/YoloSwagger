...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const LolChatGameDataChampionSummary& v) {
    j["alias"] = v.alias;
    j["id"] = v.id;
  }

  inline void from_json(const nlohmann::json& j, LolChatGameDataChampionSummary& v) {
