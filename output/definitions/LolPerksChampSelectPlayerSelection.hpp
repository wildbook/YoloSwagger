#ifndef SWAGGER_TYPES_LolPerksChampSelectPlayerSelection_HPP
#define SWAGGER_TYPES_LolPerksChampSelectPlayerSelection_HPP
#include <json.hpp>
namespace leagueapi {
  // 
  ...
  inline void to_json(nlohmann::json& j, const LolPerksChampSelectPlayerSelection& v) {
  ...
  inline void from_json(const nlohmann::json& j, LolPerksChampSelectPlayerSelection& v) {
...
#endif // SWAGGER_TYPES_LolPerksChampSelectPlayerSelection_HPP
