...
namespace leagueapi {
  ...
  inline void to_json(nlohmann::json& j, const BoostTeamSkinRentalDTO& v) {
  ...
  inline void from_json(const nlohmann::json& j, BoostTeamSkinRentalDTO& v) {
...
#endif // SWAGGER_TYPES_BoostTeamSkinRentalDTO_HPP
