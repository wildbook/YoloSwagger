...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const LolQueueEligibilityLoginSessionStates& v) {
    switch(v) {
  ...
  void from_json(const nlohmann::json& j, LolQueueEligibilityLoginSessionStates& v) {
