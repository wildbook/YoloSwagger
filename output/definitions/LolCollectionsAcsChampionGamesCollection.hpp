...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const LolCollectionsAcsChampionGamesCollection& v) {
    j["champions"] = v.champions;
    j["gameCount"] = v.gameCount;
  }

  void from_json(const nlohmann::json& j, LolCollectionsAcsChampionGamesCollection& v) {
