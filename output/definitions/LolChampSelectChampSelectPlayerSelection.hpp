...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolChampSelectChampSelectPlayerSelection& v) {
  ...
  void from_json(const nlohmann::json& j, LolChampSelectChampSelectPlayerSelection& v) {
