...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolCollectionsCollectionsSummonerIcon& v) {
    j["iconId"] = v.iconId;
    j["ownership"] = v.ownership;
  }

  void from_json(const nlohmann::json& j, LolCollectionsCollectionsSummonerIcon& v) {
