...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolInventoryRiotMessagingServiceMessage& v) {
    j["payload"] = v.payload;
  ...
  void from_json(const nlohmann::json& j, LolInventoryRiotMessagingServiceMessage& v) {
