#ifndef SWAGGER_TYPES_LolLootLootItem_HPP
#define SWAGGER_TYPES_LolLootLootItem_HPP
#include <json.hpp>
namespace leagueapi {
  // 
  ...
  inline void to_json(nlohmann::json& j, const LolLootLootItem& v) {
    j["asset"] = v.asset;
  ...
  inline void from_json(const nlohmann::json& j, LolLootLootItem& v) {
...
#endif // SWAGGER_TYPES_LolLootLootItem_HPP
