...
'    // 
  ...
  void to_json(nlohmann::json& j, const LolLobbyTeamBuilderMatchmakingDodgeState& v) {
    switch(v) {
  ...
  void from_json(const nlohmann::json& j, LolLobbyTeamBuilderMatchmakingDodgeState& v) {
