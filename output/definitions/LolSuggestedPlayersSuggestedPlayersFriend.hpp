...
namespace leagueapi {
  ...
  void to_json(nlohmann::json& j, const LolSuggestedPlayersSuggestedPlayersFriend& v) {
    j["availability"] = v.availability;
    j["id"] = v.id;
    j["name"] = v.name;
  }

  void from_json(const nlohmann::json& j, LolSuggestedPlayersSuggestedPlayersFriend& v) {
