...
namespace leagueapi
{
    ...
    struct LolClashQueue
    {
        ...
        LolClashQueueGameCategory Category { get; set; }
        ...
        LolClashQueueGameTypeConfig GameTypeConfig { get; set; }
        ...
        LolClashQueueAvailability QueueAvailability { get; set; }

        [DataMember(Name = "queueRewards")]
        LolClashQueueReward QueueRewards { get; set; }
