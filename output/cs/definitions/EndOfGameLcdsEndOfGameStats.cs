...
namespace leagueapi {
  struct EndOfGameLcdsEndOfGameStats {
    ...
    EndOfGameLcdsPointsPenalty[] PointsPenalties {get; set;}
    ...
    [DataMember(Name = "otherTeamInfo")]
    EndOfGameLcdsTeamInfo OtherTeamInfo {get; set;}
    ...
    [DataMember(Name = "teamPlayerParticipantStats")]
    EndOfGameLcdsPlayerParticipantStatsSummary[] TeamPlayerParticipantStats {get; set;}
    ...
    [DataMember(Name = "myTeamInfo")]
    EndOfGameLcdsTeamInfo MyTeamInfo {get; set;}
    ...
    [DataMember(Name = "otherTeamPlayerParticipantStats")]
    EndOfGameLcdsPlayerParticipantStatsSummary[] OtherTeamPlayerParticipantStats {get; set;}
    ...
    EndOfGameLcdsSpell[] NewSpells {get; set;}
